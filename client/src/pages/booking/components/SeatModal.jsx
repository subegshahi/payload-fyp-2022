...
export const SeatModal = () => {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-black/30  text-white">
      <div className="mx-auto max-w-7xl rounded-lg bg-white p-10 text-gray-900">
        ...
        <div className="mt-10 flex gap-5  [&>*]:basis-full">
          <button
            className="rounded-xl bg-red-500 p-4 text-lg font-semibold text-white"
            onClick={cancel}
          >
            Cancel
          </button>
          ...
          <button
            className="rounded-xl bg-brand-500 p-4 text-lg font-semibold text-white"
            onClick={checkout}
          >
            Checkout
          </button>
